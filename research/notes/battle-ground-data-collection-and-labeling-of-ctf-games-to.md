---
title: 'Battle Ground: Data Collection and Labeling of CTF Games to'
id: battle-ground-data-collection-and-labeling-of-ctf-games-to
tags:
- attack-ontology-drift-cti-85bc51
- pin-rate-survey
created: '2026-09-12T21:32:07.557073Z'
updated: '2026-09-12T21:44:19.307349Z'
source: https://arxiv.org/abs/2307.10877v1
source_domain: arxiv.org
fetched_at: '2026-09-12T21:32:07.556662Z'
...
content_type: paper
deprecated: false
summary: 'arXiv 2307.10877v1: 0 ATT&CK technique-ID occurrences, below the pin-rate-survey
  inclusion threshold of 3.'
raw_file: raw/battle-ground-data-collection-and-labeling-of-ctf-games-to.pdf
doi: arXiv:2307.10877v1
---
...
7–8, 2023, Marina del Rey, CA, USA. ACM, New York, NY, USA, 9 pages.
https://doi.org/10.1145/3607505.3607524
1
INTRODUCTION
...
affect a system based on a weakness in that very system, which is
arXiv:2307.10877v1  [cs.CR]  20 Jul 2023


---

CSET 2023, August 7–8, 2023, Marina del Rey, CA, USA
Georgel M. Savin, Ammar Asseri, Josiah Dykstra, Jonathan Goohs, Anthony Melaragno, and William Casey
...
and data collection of CTF games [3]. More broadly, cyber ranges
and testbeds may also be instrumented for data collection from
...
3.2
Stage 2: Control, Validation, and
Aggregation
...
collected using Cluster SSH and aggregated to the command server.
3.3
Stage 3: Keystroke Normalization
...
and counters 𝑘, 𝐾which track the cursor position and the right
extent of the inserted string, and apply the following algorithm and
rules given input 𝑥. The function 𝑅𝐸𝐶will record the normalized
entered command.
𝐹=


𝑅𝐸𝐶(𝐵𝑈𝐹𝐹[0 : 𝐾]),𝑘= 0, 𝐾= 0 if 𝑥=< 𝑒𝑛𝑡𝑒𝑟>
𝑘= 0 if 𝑥=< 𝑐𝑡𝑙> 𝑎
𝑘= 𝐾if 𝑥=< 𝑐𝑡𝑙> 𝑒
𝑘= 𝑚𝑖𝑛(𝑘+ 1, 𝐾) if 𝑥=< 𝑟𝑖𝑔ℎ𝑡>
𝑘= 𝑚𝑎𝑥(0,𝑘−1) if 𝑥=< 𝑙𝑒𝑓𝑡>
𝑘= 𝑚𝑖𝑛(𝑘+ 1, 𝐾) if 𝑥=< 𝑐𝑡𝑙> 𝐹
𝑘= 𝑚𝑎𝑥(0,𝑘−1) if 𝑥=< 𝑐𝑡𝑙> 𝐵
𝑘= 𝑚𝑎𝑥(0,𝑘−1), 𝐾= 𝑚𝑎𝑥(0, 𝐾−1) if 𝑥=< 𝐵𝑐𝑘𝑆𝑝>
...
for keystroke accuracy as the ratio of length of the final submitted
command buffer (i.e., 𝐾) to the number of total keystroke events.
Letting 𝐶be a counter set to zero when a command is submitted
...
𝐴= 𝐾
𝐶
Note that 𝐾is the size of the command string submitted when
...
input. One can see the effects of applying rule R to normalize input,
...
Additionally, the column labeled accuracy calculates 𝐴= 23
26 as
...
oped a new tool called Pathfinder1 to efficiently and interactively
...
4.1
Pathfinder Design and Implementation
...
view Board (IRB). The players participating in the experiment all
had some experience with CTF activities prior to the experiment.
...
retained flags leading to a score outcome of 3, 950 for the winning
Team 2 and 3, 146 for Team 1. We summarize the resulting scores
...
we applied the parsing techniques defined earlier by equation R(𝑥).
Table 3 provides a summary of the mean number of commands,
...
Finally, we calculated the number of command actions and key-
...
may be interesting to test for a pattern of warm-up and cool-down
...
of various skill levels. We plan to expand the study to explore the
relation between keystroke accuracy, learner experience, and score
...
2014. The Fun and Future of {CTF}. In 2014 {USENIX} Summit on Gaming,
Games, and Gamification in Security Education (3GSE 14).
[4] DEF CON Communications, Inc. 2023. DEF CON®Hacking Conference - Capture
the Flag Archive. https://www.defcon.org/html/links/dc-ctf.html.
Accessed:
2023-04-26.
...
[16] MITRE Engenuity. 2022.
Attack Flow.
https://center-for-threat-informed-
...
rity Symposium.
[23] Ioannis Tsimperidis, Cagatay Yucel, and Vasilios Katos. 2021. Age and Gender
