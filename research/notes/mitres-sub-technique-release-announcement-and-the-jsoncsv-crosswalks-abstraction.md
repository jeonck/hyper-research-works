---
title: 'MITRE''s sub-technique release announcement and the JSON/CSV crosswalks: abstraction
  correction, not intelligence growth'
id: mitres-sub-technique-release-announcement-and-the-jsoncsv-crosswalks-abstraction
tags:
