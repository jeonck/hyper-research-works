---
title: 'CTI-HAL: A Human-Annotated Dataset for'
id: cti-hal-a-human-annotated-dataset-for
tags:
- attack-ontology-drift-cti-85bc51
- pin-rate-survey
created: '2026-09-12T21:36:18.251725Z'
updated: '2026-09-12T21:44:35.673941Z'
source: https://arxiv.org/abs/2504.05866v1
source_domain: arxiv.org
fetched_at: '2026-09-12T21:36:18.251226Z'
...
content_type: paper
deprecated: false
summary: 'arXiv 2504.05866v1 (2025): uses 21 ATT&CK technique-ID occurrences (with
  sub-techniques); ATT&CK release declaration classified as exact_release.'
raw_file: raw/cti-hal-a-human-annotated-dataset-for.pdf
doi: arXiv:2504.05866v1
---
...
persist.
A key issue is the tendency to misinterpret
...
arXiv:2504.05866v1  [cs.CR]  8 Apr 2025
...
real CTI reports
v14.1
TTPHunter [Sentence-Based] (Rani et al., 2023) [3]
![4]
%
statement level
csv
...
MITRE ATT&CK KB
v13.1
TTPHunter [Document-Based] (Rani et al., 2023) [3]
%
!
document level
N/A
...
50 real CTI reports
v13.1
TTPXHunter [Sentence-TTP] (Rani et al., 2024) [5]
%
%
statement level
N/A
...
MITRE ATT&CK KB
v15.1
TTPXHunter [Report-TTP] (Rani et al., 2024) [5]
%
!
document level
N/A
N/A
149 real CTI reports
v15.1
CTI-to-MITRE with NLP (Orbinato et al., 2022) [6]
![7]
%
statement level
csv
...
MITRE ATT&CK KB
v7.0
MITREtrieval (Huang et al., 2024) [10]
![11]
N/A
document level
json
...
real CTI reports
v13.1
IntelEX Ground Truth (Xu et al., 2023) [14]
![15]
!
document level
docx
...
16 real CTI reports
v15.1
LADDER (Alam et al., 2023) [16]
![17]
!
statement level
csv
31
real CTI reports (Android malware)
v13.1
LLMCloudHunter (Schwartz et al., 2024) [18]
%
!
N/A
N/A
N/A
12 real CTI reports (cloud)
v15.1
aCTIon (Siracusano et al., 2023) [19]
%
!
N/A
N/A
N/A
204 real CTI reports
v13.1
AttacKG+ (Zhang et al., 2024) [20]
%
!
N/A
N/A
...
niques.
Our dataset includes reports of various sizes,
...
1https://github.com/dessertlab/CTI-HAL
2
Related Work
...
further research.
Human-Labeled.
The use of human-annotated
datasets is crucial, particularly in the context of LLMs
[27] [28].
Human-labeled data ensures a higher de-
...
tioned. These limitations hinder the application of AI
techniques.
...
shell, and executes it on the compromised host.
For
...
ing page number, id, source, tactic, sub-technique,
description, tool, notes, and link.
3.2
Classification Summary
After completing the dataset creation process, it is pos-
sible to summarize the classification results.
Table 2
...
nature.
However, there are also numerous techniques
...
dent.
The Observed Discordance (Do) [58] is the proportion
...
De = 1−Pe
(3)
where Pe represents the Expected Likelihood of Agree-
...
There is a systematic disagreement between annotators,
greater than what would be expected by chance.
0 ≤α < 0.2
Poor Agreement
The agreement is minimal and not better than what could
be expected by chance.
0.2 ≤α < 0.4
Fair Agreement
The agreement is slightly better than chance but still insuf-
ficient for many practical applications.
0.4 ≤α < 0.6
Moderate Agreement
The agreement is acceptable in some contexts but often re-
quires improvement.
0.6 ≤α < 0.8
Substantial Agreement
The agreement is considered good for most applications.
0.8 ≤α ≤1
Perfect Agreement
There is a high level of agreement between annotators.
...
and 1:
a value of 1 indicates unanimous agreement
...
SpaCy’s en core web sm model [62] was chosen
...
Recall
F1-Score
AECR (Chen et al., 2024) [1]
64.1%
68.3%
65.5%
TTPHunter (Rani et al., 2023) [3]
74.0%
77.0%
75.0%
TTPXHunter (Rani et al., 2024) [5]
97.4%
96.2%
97.1%
rcATT (Legoy et al., 2020) [8]
...
58.8%
56.6%
CTI-Bench (Alam et al., 2024) [21]
N/A
N/A
62.1%
Large-Size Report Evaluation
58.6%
63.8%
61.0%
Small-Size Report Evaluation
80.9%
72.6%
76.6%
...
Therefore, using a publicly-
available dataset is important for reproducibility and
comparability.
Moreover, ensuring data variability is
...
tured data in operational contexts.
Although perfor-
...
repository.
[3] N. Rani, B. Saha, V. Maurya, and S. K. Shukla, “Ttphunter: Auto-
...
in Proceedings of the 26th International Symposium on Research
...
[21] M. T. Alam, D. Bhusal, L. Nguyen, and N. Rastogi, “Ctibench: A
...
G0034/.
[42] Center for Threat-Informed Defense, “WizardSpider Adversary
...
S0053/.
[57] K. Krippendorff, Content Analysis:
