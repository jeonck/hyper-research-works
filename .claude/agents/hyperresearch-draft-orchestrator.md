...
1. **Batch-read in chunks of 5-8 IDs.** Stay within output limits:
   ```bash
   PYTHONIOENCODING=utf-8 /home/user/hyper-research-works/.venv/bin/hyperresearch note show <id1> <id2> <id3> <id4> <id5> -j
   ```
...
- **Citation density:** Aim comfortably above the ship gate's floor of
  9 citations per 1000 words (characters / 3 for a
