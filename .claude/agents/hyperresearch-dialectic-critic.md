...
2. **Search the vault for counter-evidence.** Use
   `/home/user/hyper-research-works/.venv/bin/hyperresearch search "<keyword>" --tag <vault_tag> -j` to find interim
   ...
   (`/home/user/hyper-research-works/.venv/bin/hyperresearch note show <id> -j`).
